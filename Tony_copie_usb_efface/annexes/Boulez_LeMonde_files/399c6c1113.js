...
"",-1E4,"/",location.hostname);tldc.tl_setCookie("_tls","",-1E4,"/",location.hostname);tldc.tl_setCookie("_tlv","",-1E4,"/",location.hostname);tldc.tl_loadAnalyticsCookies();tldc.params=tldc.tl_loadParamsCookie();tldc.tl_updateAnalyticsData()};
  ...
  tldc.injectScript({"src":"//cdn.tradelab.fr/fseg/19.js?add=1856013"}, function(){});
	if ( tldc.vis.vis_cnt > 1 ) {
		tldc.injectScript({"src":"//cdn.tradelab.fr/fseg/19.js?add=1856015"}, function(){});
	}
	else {
		if ( tldc.vis.curr_page_cnt > 1 ) {
			tldc.injectScript({"src":"//cdn.tradelab.fr/fseg/19.js?add=1856014"}, function(){});
		}
		else {
			setTimeout(function(){
				tldc.injectScript({"src":"//cdn.tradelab.fr/fseg/19.js?add=1856014"}, function(){});
  ...
  if ( dUrl.match(/abonnement\/confirmation/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=1739554"};
}
if ( dUrl.match(/abonnement\/achat/i) ) {
	scriptArray[n++] = {"code":"CmRvY3VtZW50LmNyZWF0ZUVsZW1lbnQoImltZyIpLnNyYz0iaHR0cHM6Ly9sb2FkLmV4ZWxhdG9yLmNvbS9sb2FkLz9sYj1BQTI2OTIxIjsK"};
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=1918022"};
}
if ( dUrl.match(/TLTUNNEL14/i) ) {
	scriptArray[n++] = {"code":"CmRvY3VtZW50LmNyZWF0ZUVsZW1lbnQoImltZyIpLnNyYz0iaHR0cHM6Ly9sb2FkLmV4ZWxhdG9yLmNvbS9sb2FkLz9sYj1BQTI2OTIxIjsK"};
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=1865049"};
}
if ( dUrl.match(/teaser/i) ) {
	scriptArray[n++] = {"code":"CmRvY3VtZW50LmNyZWF0ZUVsZW1lbnQoImltZyIpLnNyYz0iaHR0cHM6Ly9sb2FkLmV4ZWxhdG9yLmNvbS9sb2FkLz9sYj1BQTI2OTIxIjsK"};
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=1865050"};
}
if ( dUrl.match(/abo/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=3089582"};
}
if ( dUrl.match(/mobile/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=3077904"};
}
if ( dUrl.match(/1euro/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=3089582"};
}
if ( dUrl.match(/integrale/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=3220804"};
}
if ( dUrl.match(/weekend/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=3220814"};
}
if ( dUrl.match(/decouverte/i) ) {
	scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=3220799"};
}
scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=1739553"};
scriptArray[n++] = {"src":"//cdn.tradelab.fr/seg.js?add=1878333"};
scriptArray[n++] = {"code":""};
scriptArray[n++] = {"code":""};
scriptArray[n++] = {"code":""};
scriptArray[n++] = {"code":""};
